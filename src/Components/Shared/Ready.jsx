  ...
  return (
    <div className="w-11/12 mx-auto mb-10 bg-[#8B5CF6] text-white rounded-3xl py-20 px-10 flex items-center justify-between gap-10">
      <div>
        ...
        <p className="text-lg font-medium text-gray-200 mb-3 w-3/4">
          Join the elite marketplace where quality meets speed. Hire the top 1%
          of freelance talent or find your next high-paying gig today.
        </p>
        <div className="flex gap-3 mt-5">
          <Button
            variant="primary"
            size="large"
            className="p-6 bg-white text-black rounded-2xl"
          >
            Get Started
          </Button>
          <Button
            variant="outline"
            size="large"
            className="p-6 rounded-2xl text-white font-bold "
          >
