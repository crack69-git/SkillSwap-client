...
const ProfileEditPage = () => {
  ...
  const onSubmit = (e) => {
    ...
    // Convert Selection object to array
    data.techStack = selectedKeys;
    console.log(data);
  };
        ...
        <Fieldset>
          ...
          <FieldGroup>
            ...
            <Select
              ...
              value={selectedKeys} // <-- Change this from selectedKeys
            ...
            >
              ...
              <Select.Popover>
                <ListBox selectionMode="multiple">{selectOptions}</ListBox>
              </Select.Popover>
            </Select>
